...
#include "adapters/display/layouts/Layout3Tires.h"
...
#include "adapters/motors/GaugeMotorTmc2208.h"
...
// ===== UI =====
static Layout0Basic layout0;
static Layout1Minimal layout1;
static Layout2Performance layout2;
static Layout3Tires layout3;
static DisplayLayoutEntry displayLayouts[] = {
  {0, &layout0},
  {1, &layout1},
  {2, &layout2},
  {3, &layout3}
};
static DisplayService ui(displayLayouts, sizeof(displayLayouts) / sizeof(displayLayouts[0]));
...
static SpeedGauge speedGauge(speedMotor, systemClock, speedGaugeCfg);
static RpmGauge rpmGauge(rpmMotor, systemClock, rpmGaugeCfg);
static FuelGauge fuelGauge(fuelMotor, systemClock, fuelGaugeCfg);
static TireTempGauge tireTempGauge(tempMotor, systemClock, tireTempGaugeCfg);
static IInstrument* clusterInstruments[] = {
  &speedGauge,
  &rpmGauge,
  &fuelGauge,
  &tireTempGauge
